...
.center {
  ...
  margin-right: auto;
    ...
    /*Closing Image Large Css*/
     ...
     <div style="float: right; padding: 16px;"> <a href="#barabr" onclick="AjaxPage('Pages/SellerProfile/SellerProfile/fa-User/fa-user', 'DivMainContainer');" title="back"><img src="{{asset('public/assets/img/back.png')}}" style="width:18px;"> Back </a></div>
     ...
     @elseif($sAction == "ViewData")
      ...
      <table class="CustomeTable">
          ...
          <tr>
              <td> Seller Account No </td><td> {{ $aData['SellerAccountNo'] }} </td>
          </tr>
          <tr>
              <td> VatNo: </td><td> {{ $aData['VatNo'] }} </td>
          </tr>
          ...
          <tr>
           ...
           @if($aData['SajalTijariNo'] != "")
            ...
            @else
              <img id="myImg" src="{{ asset('public/assets/images/SellerSajalTijariNo/NoPhoto.jpg') }}" alt="Snow" style="width:100%;max-width:300px">

              <!-- The Modal -->
              <div id="myModal" class="modal center">
                <span class="close" style="color: white;">&times;</span>
                <center>
                <img src="{{ asset('public/assets/images/SellerSajalTijariNo/NoPhoto.jpg') }}"/>
                </center>
                <div id="caption"></div>
              </div>
            @endif
