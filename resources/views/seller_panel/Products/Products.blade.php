...
h1 {
  ...
  @endif
     ...
     <div style="float: right; padding: 16px;"> <a href="#basera" onclick="AjaxPage('Pages/Products/Products/fa-product-hunt/fa-product-hunt', 'DivMainContainer');" title="back"><img src="{{asset('public/assets/img/back.png')}}" style="width:18px;"> Back </a></div>
