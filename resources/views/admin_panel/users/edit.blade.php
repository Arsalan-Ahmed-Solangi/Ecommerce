        ...
        <div class="card shadow-sm bg-white" >
            ...
            <div class="card-body" style="padding:0px 0px 0px 10px">
                @if (count($errors) > 0)
                 ...
                 {!! Form::model($subcategory,array('route' => ['subcategories.update',$subcategory->sub_category_id ],'method'=>'PUT','id'=>'form')) !!}


                        <div class="form-group">
                            <strong>Name <span class="text-danger">*</span></strong>
                            {!! Form::text('title', null, array('placeholder' => 'Enter Name','class' => 'form-control','name'=>'title')) !!}

                        </div>

                        <div class="form-group">
                            <strong>Category <span class="text-danger">*</span></strong>
                            {!! Form::select('category_id',$categories ?? array(), null, array('class' => 'form-control','placeholder'=>'--SELECT CATEGORY--')) !!}
                        </div>
