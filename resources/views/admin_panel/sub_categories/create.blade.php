    ...
    <div class="container-fluid" style="box-shadow: 1px 4px 8px 0 rgba(0,0,0,0.2);">
        <div class="card shadow-sm bg-white" >
            <div class="card-header">
                <h5><i class="fa fa-plus-circle"></i> Add Sub Category</h5>
                <hr/>
            ...
            <div class="card-body">
              ...
              @endif
                <form action="{{ route('subcategories.store')  }}" method="POST" id="form">
                    @csrf

                    <div class="form-group">
                        <strong>Name <span class="text-danger">*</span></strong>
                        {!! Form::text('title', null, array('placeholder' => 'Enter Name','class' => 'form-control','required')) !!}
                    </div>

                    <div class="form-group">
                        <strong>Category  <span class="text-danger">*</span></strong>
                        {!! Form::select('category_id',$categories, null, array('class' => 'form-control','required','placeholder'=>'--SELECT CATEGORY--')) !!}
                    </div>
