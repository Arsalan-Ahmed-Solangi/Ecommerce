...
.center {
  ...
  margin-right: auto;
    ...
    /*Closing Image Large Css*/
     ...
     <div style="float: right; padding: 16px;"> <a href="#barabr" onclick="AjaxPage('Pages/BarabrSystemAdmin/Sellers/fa-User/fa-user', 'DivMainContainer');" title="back"><img src="{{asset('public/assets/img/back.png')}}" style="width:18px;"> Back </a></div>
