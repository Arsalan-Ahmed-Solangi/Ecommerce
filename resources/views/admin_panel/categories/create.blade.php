    ...
    <div class="container-fluid" style="box-shadow: 1px 4px 8px 0 rgba(0,0,0,0.2);">
        <div class="card shadow-sm bg-white" >
            <div class="card-header">
                <h5><i class="fa fa-plus-circle"></i> Add Category</h5>
                <hr/>
              ...
              @endif
                <form action="{{ route('categories.store')  }}" method="POST" id="form">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('title', null, array('placeholder' => 'Enter Category Name','class' => 'form-control','required')) !!}
                    </div>

                    <div class="form-group">
                        <strong>Category Description <span class="text-danger">*</span></strong>
                        {!! Form::textarea('description', null, array('placeholder' => 'Enter Category Name','rows' => 4,'class' => 'form-control','required')) !!}
                    </div>
