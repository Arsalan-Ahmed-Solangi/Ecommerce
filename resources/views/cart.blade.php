                        ...
                        <tbody>
                            ...
                            <tr>
                                <form action="{{ route('deleteCart')}}" method="POST">
                                  @csrf  <input type="hidden" name="cart_id" value="{{ $value->cart_id  }}"/>
                                ...
                                <td>
                                    <form action="{{ route('updateCart')}}" method="POST">
                                        @csrf  <input type="hidden" name="cart_id" value="{{ $value->cart_id  }}"/>
                                    <input type="number" min="1" max="{{ $value->product_stock  }}" class="form-control" style="width:100px" value="{{ $value->quantity  }}" name="quantity"/>
                                    <button type="submit" class="btn btn-soft-secondary  mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5 w-100 w-md-auto">Update</button>

                                </form>
                                </td>
                                <td>
                                    {{ "$".$value->product_selling_price *  $value->quantity   }}
                                    @php $total += $value->product_selling_price *  $value->quantity @endphp
                                </td>
                            </tr>
                            @endforeach
                            @else
